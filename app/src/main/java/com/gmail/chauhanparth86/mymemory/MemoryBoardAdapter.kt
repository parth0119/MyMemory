...
import com.gmail.chauhanparth86.mymemory.models.MemoryCard
...
class MemoryBoardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val layoutParams =
            view.findViewById<MaterialCardView>(R.id.cardView).layoutParams as ViewGroup.MarginLayoutParams
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(position: Int) {
            ...
            if (memoryCard.isFaceUp) {
                ...
                imageButton.setImageResource(R.drawable.loop)
            }
