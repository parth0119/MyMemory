...
import com.gmail.chauhanparth86.mymemory.models.BoardSize
import com.gmail.chauhanparth86.mymemory.utils.*
...
class CreateActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val PICK_PHOTO_CODE = 307
        private const val READ_EXTERNAL_PHOTOS_CODE = 78
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode != PICK_PHOTO_CODE || resultCode != Activity.RESULT_OK || data == null) {
            Log.w(TAG, "Did not get data from launched activity")
            return
        }
        ...
        db.collection("games").document(customGameName).get().addOnSuccessListener { document ->
            if (document != null && document.data != null) {
                AlertDialog.Builder(this)
                    .setTitle("Name Taken")
                    .setMessage("A game with the name '$customGameName' already exists. Please choose another")
    ...
    private fun handleImageUploading(gameName: String) {
        ...
        // Check that name isn't a duplicate
        for ((index: Int, photoUri: Uri) in chosenImageUris.withIndex()) {
            ...
            photoReference.putBytes(imageByteArray)
                .continueWithTask { photoUploadTask ->
                ...
                }.addOnCompleteListener { downloadUtlTask ->
                    if (!downloadUtlTask.isSuccessful) {
                        Log.e(TAG, "Exception with Firebase Storage", downloadUtlTask.exception)
                    ...
                    val downloadUrl: String = downloadUtlTask.result.toString()
    ...
    private fun getImageByteArray(photoUri: Uri): ByteArray {
        ...
        val scaledBitmape = BitmapScaler.scaleToFitWidth(originalBitmap, 250)
        Log.i(TAG, "Scaled Width ${scaledBitmape.width} and height ${scaledBitmap.height}")
